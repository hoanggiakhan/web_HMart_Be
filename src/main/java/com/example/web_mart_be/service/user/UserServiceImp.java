package com.example.web_mart_be.service.user;

import com.example.web_mart_be.dao.RoleRepository;
import com.example.web_mart_be.dao.UserRepository;
import com.example.web_mart_be.entity.Notification;
import com.example.web_mart_be.entity.Role;
import com.example.web_mart_be.entity.User;
import com.example.web_mart_be.security.JwtResponse;
import com.example.web_mart_be.service.JWT.JwtService;
import com.example.web_mart_be.service.email.EmailService;
...
//        String endpointFE = "https://d451-203-205-27-198.ngrok-free.app";
        ...
        try {
            emailService.sendMessage("levanadev916@gmail.com", email, subject, message);
        } catch (Exception e) {
