package com.example.web_mart_be.service.cart;

import com.example.web_mart_be.dao.CartItemRepository;
import com.example.web_mart_be.dao.UserRepository;
import com.example.web_mart_be.entity.CartItem;
        ...
        try{
            ...
            for (CartItem cartItemData : cartItemDataList) {
                ...
                for (CartItem cartItem : cartItemList) {
                    ...
                    if (cartItem.getProduct().getIdProduct() == cartItemData.getProduct().getIdProduct()) {
                ...
                if (!isHad) {
                    ...
                    cartItem.setProduct(cartItemData.getProduct());
